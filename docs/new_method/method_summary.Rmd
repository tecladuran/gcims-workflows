...
scores_acq_df <- data.frame(Sample = 1:nrow(X),
                            PC1 = pca_acq$x[,1],
                            Acquisition = factor(df$acquisition_index))

p1 <- ggplot(scores_batch_df, aes(x = Sample, y = PC1, color = factor(Batch))) +
  geom_line(aes(group = 1), color = "grey40", linewidth = 1, alpha = 0.7) +
...
p2 <- ggplot(scores_acq_df, aes(x = Sample, y = PC1, color = Acquisition)) +
  geom_line(aes(group = 1), color = "grey40", linewidth = 1, alpha = 0.7) +
  geom_point(size = 2.2) +
  scale_color_viridis_d(option = "G", name = "Acquisition") +
...
ggsave(
  "~/Documents/gcims/gcims-workflows/figures/new_method_figures/pcs/pc1_scores_batch_acquisition.png",
  combined_plot,
  width = 9,
  height = 7,
  dpi = 600
...
ggsave(
  "~/Documents/gcims/gcims-workflows/figures/new_method_figures/pcs/pc1_scores_batch_acquisition.pdf",
  combined_plot,
  width = 9,
  height = 7
)
