Stability analysis of the GC-IMS Peak Table
================
Tecla Duran Fort
2025-04-19
...
<img src="Stability_analysis_pdf_files/figure-latex/barplot-r-squared-1.png" alt="Proportion of variance in cluster intensity explained by elapsed time, batch, and other factors"  />
<p class="caption">
Proportion of variance in cluster intensity explained by elapsed time,
batch, and other factors
</p>
