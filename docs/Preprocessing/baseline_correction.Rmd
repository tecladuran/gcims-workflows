...
ggplot(results, aes(x = ampliation, y = MinValue, color = factor(SampleID), group = SampleID)) +
  geom_line() +
  geom_point() +
  labs(title = "Low-Decile Intensity vs ROI Expansion (Cluster 1)",
       x = "Expansion (%)",
       y = "Minimum Value",
       color = "Sample ID") +
  theme_minimal()+
...
ggplot(results, aes(x = ampliation, y = MinValue, color = factor(SampleID), group = SampleID)) +
  geom_line() +
  geom_point() +
  labs(title = "Low-Decile Intensity vs ROI Expansion (Cluster 14)",
       x = "Expansion (%)",
       y = "Minimum Value",
       color = "Sample ID") +
  theme_minimal()+
...
ggplot(mean_results, aes(x = ampliation, y = MeanMinValue, color = factor(cluster), group = cluster)) +
  geom_line() +
  geom_point() +
  labs(title = "Mean Low-Decile Intensity vs ROI Expansion per Cluster",
       x = "Expansion (%)",
